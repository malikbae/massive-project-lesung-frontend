      ...
      <footer class="bg-slate-600 dark:bg-gray-900">
        <div class="mx-auto w-full max-w-screen-xl">
          <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
            <div>
              <h2 class="mb-6 text-4xl font-bold text-gray-200 dark:text-white">
                MaLes
              </h2>
              <ul class="text-gray-200 font-small text-sm">
                <li class="mb-4 mr-4">
                  <a href="#" class="">
                    Dapatkan pengalaman bimbingan belajar atau les privat dengan
                    guru les berkualitas yang sesuai dengan kebutuhan preferensi
                    anda. Kami menyediakan platform yang memudahkan Anda
