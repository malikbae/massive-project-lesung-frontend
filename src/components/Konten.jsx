...
const Konten = () => {
  ...
  useEffect(() => {
    if (document.getElementById("column-chart") && typeof ApexCharts !== "undefined" && !chartRendered) {
        ...
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
              ...
              <div class="flex flex-rows grid grid-rows-2 items-center justify-center h-48 rounded bg-primary dark:bg-gray-800">
                <div className="mt-10">
                  ...
                  <p class="ms-2 text-xl text-background dark:text-gray-500">
                    <span class="d-flex align-items-center justify-content-center font-semibold">User</span>
                  </p>
                </div>
                <p class="flex items-center justify-center text-md font-semibold text-background dark:bg-blue-900 dark:text-blue-300">100</p>
              </div>
            </Link>
            <Link to="/guru">
              <div class="flex flex-rows grid grid-rows-2 items-center justify-center h-48 rounded bg-primary dark:bg-gray-800">
                <div className="mt-10">
                  ...
                  <p class="ms-2 text-xl text-background dark:text-gray-500">
                    <span class="d-flex align-items-center justify-content-center font-semibold">Guru</span>
                  </p>
                </div>
                <p class="flex items-center justify-center text-md font-semibold text-background dark:bg-blue-900 dark:text-blue-300">45</p>
              </div>
            </Link>
            <Link to="/kelas-berlangsung">
              <div class="flex flex-rows grid grid-rows-2 items-center justify-center h-48 rounded bg-primary dark:bg-gray-800">
                <div className="mt-10">
                  ...
                  <p class="ms-2 text-xl text-background dark:text-gray-500">
                    <span class="d-flex align-items-center justify-content-center font-semibold">Siswa</span>
                  </p>
                </div>
                <p class="flex items-center justify-center text-md font-semibold text-background dark:bg-blue-900 dark:text-blue-300">55</p>
              </div>
            </Link>
          </div>
          ...
          <div class="flex items-center justify-left h-36 mb-4 rounded bg-gray-50 dark:bg-gray-800">
            <div className="flex grid grid-rows-2 m-8">
              <p class="text-2xl font-medium text-black dark:text-gray-500">Transaction Graph</p>
              <p class="text-l font-thin text-gray-600 dark:text-gray-500">Summary and current transaction activity.</p>
            </div>
          </div>
            ...
            <div class="flex items-center justify-start rounded h-28 dark:bg-gray-800">
              <div class="flex items-center justify-start grid grid-cols-2 gap-4">
                <div className="flex grid grid-row-2 m-8 ">
                  <p class="text-l font-thin text-gray-600 dark:text-gray-500">Cash</p>
                  <div className="flex grid grid-cols-2">
                    <p class="text-2xl font-medium text-black dark:text-gray-500">30%</p>
                    <p class="text-l font-medium text-green-600 dark:text-gray-500 mt-1 ml-2">5.90%</p>
                  </div>
                </div>
              </div>
            </div>
