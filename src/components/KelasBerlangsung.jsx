...
const KelasBerlangsung = () => {
  const [users, setUsers] = useState([
    {
      id: 1,
      name: "John Doe Alacadabra",
      email: "johndoealacadabra9910@example.com",
      status: "Proses",
      role: "1/9",
    },
    {
    ...
    <div>
      ...
      <div class="p-4 sm:ml-64">
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
          <div>
            <p className="text-2xl font-medium text-black dark:text-gray-500">
              Data User
            </p>
            <p className="text-l font-thin text-gray-600 dark:text-gray-500">
              18 results found
            </p>
          </div>
...
export default KelasBerlangsung;
